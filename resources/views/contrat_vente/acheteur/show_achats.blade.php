    ...
    <body class="antialiased">
        ...
        <div class="divided-div">
            ...
            <div class="right-div">
                ...
                @else
                    <br>
                    <h3>Vous ne disposez aucun contrat d'achat.</h3>
                @endif  
            </div>
        </div>
            ...
            $(document).ready(function() {
                ...
                function sortDataByType(type) {
                    ...
                    if(sortedContrats.length > 0) {
                        ...
                        $('#contrats-container').text('Vous ne disposez aucun contrats d\'achat des '+ type +'s .');
                }
                ...
                $('#contrats-container').text('Vous ne disposez aucun contrats d\'achat des '+ selectedType +'s .');
            });
        </script>
    </body>
</html>